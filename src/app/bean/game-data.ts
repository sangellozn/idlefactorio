...
export class GameData {
    ...
    public static initResourceCost(): void {
        ...
        GameData.resourcesByCode.get('PLASBAR').buildCost = [new BuildCost(GameData.resourcesByCode.get('COAL'), 1), new BuildCost(GameData.resourcesByCode.get('PGAS'), 20)];
        GameData.resourcesByCode.get('ADVC').buildCost = [new BuildCost(GameData.resourcesByCode.get('CC'), 4), new BuildCost(GameData.resourcesByCode.get('EC'), 2), new BuildCost(GameData.resourcesByCode.get('PLASBAR'), 2)];
        GameData.resourcesByCode.get('ASSM1').buildCost = [new BuildCost(GameData.resourcesByCode.get('EC'), 3), new BuildCost(GameData.resourcesByCode.get('IGW'), 5), new BuildCost(GameData.resourcesByCode.get('IROPL'), 9)];
        GameData.resourcesByCode.get('ASSM2').buildCost = [new BuildCost(GameData.resourcesByCode.get('ASSM1'), 1), new BuildCost(GameData.resourcesByCode.get('EC'), 3), new BuildCost(GameData.resourcesByCode.get('IGW'), 5), new BuildCost(GameData.resourcesByCode.get('IROPL'), 9)];
